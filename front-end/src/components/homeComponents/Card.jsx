...
const Card = ({ usuario, match }) => {
  ...
  return (
    <div style={{ justifyContent: "center", alignItems: "center", display: liked ? "none" : "flex", flexDirection: "column", borderRadius: "10px", boxShadow: "10px 4px 7px rgba(0, 0, 0, 0.4)", width: "500px", height: '670px', margin: "0 auto" }}>
